...
public final class NivelUno extends PantallaNivel {

	public NivelUno(Game juego) {
	...
	protected void pasarNivel() {
		Niveles.nivelDos = new NivelDos(juego);
//		Niveles.nivelUno = null;
		juego.setScreen(Niveles.nivelDos);
	}
}
